...
function initQuizPage() {
  ...
  if (!questions.length) {
    window.location.href = meta.unit === "unit2" ? "unit2.html" : (meta.unit === "unit3" ? "unit3.html" : "unit1.html");
    return;
  }
  ...
  const unitLabel = meta.unit === "unit2" ? "Unit 2" : (meta.unit === "unit3" ? "Unit 3" : "Unit 1");
...
function initResultPage() {
  ...
  const unitLabel = result.unit === "unit2" ? "Unit 2" : (result.unit === "unit3" ? "Unit 3" : "Unit 1");
  const resultTitle = document.getElementById("resultTitle");
  const unitPage = result.unit === "unit2" ? "unit2.html" : (result.unit === "unit3" ? "unit3.html" : "unit1.html");
  if (resultTitle) {
